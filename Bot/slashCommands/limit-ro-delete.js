...
module.exports = {
	name: "limit-ro-delete",
	description: "Set roles delete limit",
  type: "CHAT_INPUT",
	options: [{
    name: "number",
   ...
   db.set(`ROLES-DELETE-LIMIT_${interaction.guild.id}`, limit) 
...
.setColor("BLUE")
.setDescription(`**By : ${interaction.user}\nAction : Updated Limit Roles Delete\nNew Limit : ${limit}\nDate On : ${require("moment")(new Date()).format("DD/MM/YYYY hh:mm")}**`)
.setFooter(interaction.guild.name, interaction.guild.iconURL({dynamic:true}))
  
  interaction.reply({content: `**✅ Successfully updated roles delete limit to \`${limit}\`**`})
