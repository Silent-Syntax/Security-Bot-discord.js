...
module.exports = {
	name: "limit-ch-delete",
	description: "Set channels delete limit",
  type: "CHAT_INPUT",
	options: [{
    name: "number",
   ...
   db.set(`CHANNELS-DELETE-LIMIT_${interaction.guild.id}`, limit) 
...
.setColor("BLUE")
.setDescription(`**By : ${interaction.user}\nAction : Updated Limit Channels Delete\nNew Limit : ${limit}\nDate On : ${require("moment")(new Date()).format("DD/MM/YYYY hh:mm")}**`)
.setFooter(interaction.guild.name, interaction.guild.iconURL({dynamic:true}))
  
  interaction.reply({content: `**✅ Successfully updated channels delete limit to \`${limit}\`**`})
