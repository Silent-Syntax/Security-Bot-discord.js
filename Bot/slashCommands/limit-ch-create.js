...
module.exports = {
	name: "limit-ch-create",
	description: "Set channels create limit",
  type: "CHAT_INPUT",
	options: [{
    name: "number",
   ...
   db.set(`CHANNELS-CREATE-LIMIT_${interaction.guild.id}`, limit) 
...
.setColor("BLUE")
.setDescription(`**By : ${interaction.user}\nAction : Updated Limit Channels Create\nNew Limit : ${limit}\nDate On : ${require("moment")(new Date()).format("DD/MM/YYYY hh:mm")}**`)
.setFooter(interaction.guild.name, interaction.guild.iconURL({dynamic:true}))
  
  interaction.reply({content: `**✅ Successfully updated channels create limit to \`${limit}\`**`})
